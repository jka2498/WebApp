package com.sparta.jka.greeting;
...
public class HttpServletClass extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String path = "WEB-INF/JSP/http.jsp";
        resp.setContentType("text/html");
        String param = req.getParameter("control");
        if(param != null) {
            if(param.equals("headers")){
                setHeaderAttributues(req);
                path = "WEB-INF/JSP/headerInfo.jsp";
            } else if (param.equals("paths")){
                setAttributes(req);
                path = "WEB-INF/JSP/requestInfo.jsp";
            }
        }
    ...
    private void setHeaderAttributues(HttpServletRequest req) {
